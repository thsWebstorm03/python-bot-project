...
<head>
    ...
    <title>Manage VISAs - Permission</title>
        ...
        <div class="pt-3 w-[calc(100vw-280px)] h-screen">
            ...
            <div class="h-[calc(100vh-0.9rem)] p-[32px] rounded-tl-[32px] rounded-bl-[32px] bg-white overflow-y-auto">
                ...
                <div class="flex justify-between">
                    <!-- Page Title -->
                    <h1 class="text-[30px] font-semibold">Permission רְשׁוּת</h1>
                    <!-- Language Button -->
                ...
                <!-- Users Table -->
                <div class="mt-10">
                    <h1 class="text-right text-[21px] font-semibold">Administrators</h1>
                    <hr>
                    ...
                    <table id="tbl-admins" class="w-full mt-5">
                        <thead class="bg-primary-normal text-white text-center">
                            <tr>
                                <th class="py-[12px] px-[40px] rounded-tl-[24px]">No</th>
                                <th class="py-[12px] px-[40px]">Name</th>
                                <th class="py-[12px] px-[40px]">Email</th>
                                <th class="py-[12px] px-[40px]">Password</th>
                                <th class="py-[12px] px-[40px]">Last Signed In</th>
                                <th class="py-[12px] px-[40px]">Permission</th>
                                <th class="py-[12px] px-[40px]">Online</th>
                                <th class="py-[12px] px-[40px] rounded-tr-[24px]">
                        ...
                        <tbody class="text-center">
                            <tr><td colspan="8" class="py-[12px] px-[40px]">No data to display.</td></tr>
                        </tbody>
                        <tfoot class="bg-primary-normal text-white text-center">
                            <tr><td colspan="8" class="py-[8px] px-[40px] rounded-bl-[24px] rounded-br-[24px]">Showing information of all adminstrators.</td></tr>
                        </tfoot>
                    </table>
                </div>
            </div>
